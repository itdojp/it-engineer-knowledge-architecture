...
既存書籍 39 冊は、[既存書籍レビュー・改善ロードマップ #153](https://github.com/itdojp/it-engineer-knowledge-architecture/issues/153) に基づく横断レビューを完了しています。公開カタログでは、次の順序で読むと書籍間の役割が分かりやすくなります。
...
30. 要件から始めるソフトウェア設計（小規模TS Webアプリの実践）  

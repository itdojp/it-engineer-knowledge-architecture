...
- [シリーズ共通ガイド](https://itdojp.github.io/it-engineer-knowledge-architecture/publishing/)
- [公開前レビュー・チェックリスト](https://itdojp.github.io/it-engineer-knowledge-architecture/publishing/review-checklist.html)
- [Professional Foundations 実装ガイド](https://itdojp.github.io/it-engineer-knowledge-architecture/professional-foundations/)
...
既存39冊は、[既存書籍レビュー・改善ロードマップ #153](https://github.com/itdojp/it-engineer-knowledge-architecture/issues/153) に基づく横断レビューを完了しています。2026-06-29 に「理論計算機科学を読むための数学・証明・アルゴリズム基礎」を追加し、既存書籍は40冊になりました。公開カタログでは、次の順序で読むと書籍間の役割が分かりやすくなります。
...
レビュー結果の横断サマリは [既存書籍レビュー完了サマリ](https://itdojp.github.io/it-engineer-knowledge-architecture/publishing/content-review-summary-2026.html)、残 follow-up の優先順位は [follow-up Issue 優先順位](https://itdojp.github.io/it-engineer-knowledge-architecture/publishing/follow-up-priorities.html) に記録しています。Professional Foundations の導入順、書籍企画、横断テンプレートは [Professional Foundations 実装ガイド](https://itdojp.github.io/it-engineer-knowledge-architecture/professional-foundations/) に集約しています。
...
導入順、書籍企画、README / Issue / PR / ADR / 障害報告などの横断テンプレートは [Professional Foundations 実装ガイド](https://itdojp.github.io/it-engineer-knowledge-architecture/professional-foundations/) を参照してください。
...
28. AIエージェント実践: Prompt / Context / Harness Engineering
...
31. 要件から始めるソフトウェア設計（小規模TS Webアプリの実践）
...
- 導入ガイド: [Professional Foundations 実装ガイド](https://itdojp.github.io/it-engineer-knowledge-architecture/professional-foundations/)
...
- [日本語トップページ](https://itdojp.github.io/it-engineer-knowledge-architecture/)

...
function fixedReason(code) {
  const messages = {
    ...
    'security-scheduled': 'セキュリティアラート照会は権限を持つ定期実行で確認します。',

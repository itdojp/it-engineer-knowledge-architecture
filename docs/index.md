...
11. Kubernetes: Proxmox検証からクラウド本番へ  
...
16. 圏論によるAIエージェント時代の合成的ソフトウェア設計  
...
22. 要件から始めるソフトウェア設計（小規模TS Webアプリの実践）  
...
- 31 books in this series (Japanese; most are free to read online via GitHub Pages)
- 7 planned books

...
| Canonical title | Availability | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- |
| 根拠で進める開発仕事術：検索戦略・検証・引用の実務 | `JA only` | All levels | Explains how to search, verify, quote, and document evidence so engineering decisions stay defensible. | [Read](https://itdojp.github.io/evidence-based-engineering-book/) / [Repository](https://github.com/itdojp/evidence-based-engineering-book) |
| チケット駆動の仕事術：良いIssueとPRで回すタスク管理・報告・合意形成 | `JA only` | All levels | Shows how to manage work with high-quality issues and pull requests for tracking, reporting, and consensus building. | [Read](https://itdojp.github.io/issue-driven-work-book/) / [Repository](https://github.com/itdojp/issue-driven-work-book) |
| エンジニアリングドキュメント実践ガイド：README・手順書・Runbook・ADR・ポストモーテム | `JA only` | All levels | Covers practical engineering documents such as READMEs, procedures, runbooks, ADRs, and postmortems. | [Read](https://itdojp.github.io/engineering-documentation-book/) / [Repository](https://github.com/itdojp/engineering-documentation-book) |
| セキュリティ＆プライバシー基礎リテラシー：秘密情報・権限・データ取り扱い | `JA only` | All levels | Introduces everyday security and privacy practice around secrets, permissions, and responsible data handling. | [Read](https://itdojp.github.io/security-privacy-literacy-book/) / [Repository](https://github.com/itdojp/security-privacy-literacy-book) |
| インシデント対応 基礎：切り分け・状況共有・復旧・ポストモーテムの型 | `JA only` | All levels | Provides a reusable incident response pattern from initial triage through communication, recovery, and postmortem review. | [Read](https://itdojp.github.io/incident-response-basics-book/) / [Repository](https://github.com/itdojp/incident-response-basics-book) |
...
| Canonical title | Availability | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- |
| 実践Linux インフラエンジニア入門 | `JA only` | 0–2 years | Builds Linux infrastructure fundamentals for modern operations, including systems, networking, process management, and security basics. | [Read](https://itdojp.github.io/linux-infra-textbook2/) / [Repository](https://github.com/itdojp/linux-infra-textbook2) |
| ITインフラエンジニアのためのソフトウェア基礎知識 | `JA only` | 0–2 years | Explains the software concepts infrastructure engineers need for packages, code reading, APIs, databases, and runtime behavior. | [Read](https://itdojp.github.io/it-infra-software-essentials-book/) / [Repository](https://github.com/itdojp/it-infra-software-essentials-book) |
| ITインフラストラクチャ技術ガイド | `JA only` | 0–2 years | Organizes the design principles behind protocols, networks, operating systems, and storage for infrastructure engineers. | [Read](https://itdojp.github.io/IT-infra-book/) / [Repository](https://github.com/itdojp/IT-infra-book) |
...
| Canonical title | Availability | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- |
| ITインフラトラブルシューティング実践ガイド | `JA only` | Intermediate+ | Teaches systematic troubleshooting through hypothesis building, observation, isolation, verification, and recovery. | [Read](https://itdojp.github.io/IT-infra-troubleshooting-book/) / [Repository](https://github.com/itdojp/IT-infra-troubleshooting-book) |
| クラウドインフラ設計・構築ガイド | `JA only` | Intermediate+ | Focuses on designing and building cloud infrastructure with sound choices for compute, storage, networking, and operations. | [Read](https://itdojp.github.io/cloud-infra-book/) / [Repository](https://github.com/itdojp/cloud-infra-book) |
...
| Canonical title | Availability | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- |
| インフラエンジニアのための情報セキュリティ実装ガイド | `JA only` | Intermediate+ | Covers practical security controls for infrastructure, including identity, hardening, monitoring, and incident readiness. | [Read](https://itdojp.github.io/it-infra-security-guide-book/) / [Repository](https://github.com/itdojp/it-infra-security-guide-book) |
| 実務で使えるペネトレーションテスト大全 | `JA only` | Intermediate+ | Introduces penetration testing workflows, tooling, and reporting for real-world security assessments. | [Read](https://itdojp.github.io/pentest-learning-book/) / [Repository](https://github.com/itdojp/pentest-learning-book) |
...
| Canonical title | Availability | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- |
| Proxmox VE 実践ガイド | `JA only` | Intermediate+ | Explains how to build and operate virtualization environments with Proxmox VE in practical scenarios. | [Read](https://itdojp.github.io/proxmox_book/) / [Repository](https://github.com/itdojp/proxmox_book) |
| Kubernetes入門：PodからIngressまで（基礎と実践） | `JA only` | Intermediate+ | Introduces Kubernetes from core objects to service exposure, with hands-on operational basics. | [Read](https://itdojp.github.io/kubernetes-basics-book/) / [Repository](https://github.com/itdojp/kubernetes-basics-book) |
| Kubernetesクラスタ設計・運用実践ガイド | `JA only` | Intermediate+ | Covers Kubernetes cluster design and day-2 operations with reliability, lifecycle, and security concerns in mind. | [Read](https://itdojp.github.io/kubernetes-cluster-ops-book/) / [Repository](https://github.com/itdojp/kubernetes-cluster-ops-book) |
| Kubernetes: Proxmox検証からクラウド本番へ | `JA only` | Intermediate+ | Bridges local Proxmox-based Kubernetes experiments to cloud production architecture and operations. | [Read](https://itdojp.github.io/kubernetes-proxmox-to-cloud-book/) / [Repository](https://github.com/itdojp/kubernetes-proxmox-to-cloud-book) |
| Podman完全ガイド | `JA only` | Intermediate+ | Explains Podman-based container workflows, including images, storage, networking, pods, and rootless operation. | [Read](https://itdojp.github.io/podman-book/) / [Repository](https://github.com/itdojp/podman-book) |
| 実践 認証認可システム設計 | `JA only` | Intermediate+ | Designs authentication and authorization systems from sessions and tokens to OAuth 2.0, OIDC, and federated identity. | [Read](https://itdojp.github.io/practical-auth-book/) / [Repository](https://github.com/itdojp/practical-auth-book) |
| Supabaseアーキテクチャ | `JA only` | Intermediate+ | Uses Supabase as a practical application platform covering auth, data, edge functions, and operations. | [Read](https://itdojp.github.io/supabase-architecture-patterns-book/) / [Repository](https://github.com/itdojp/supabase-architecture-patterns-book) |
...
| Canonical title | Availability | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- |
| Mathematics, Proofs, and Algorithms for Reading Theoretical Computer Science | `JA only` | Intermediate+ | A Japanese bridge textbook for readers who need prerequisites before studying theoretical computer science: sets, logic, proofs, asymptotic notation, graphs, counting, data structures, formal languages, probability, number theory, linear algebra, and concurrency models. | [Read](https://itdojp.github.io/theoretical-computer-science-prerequisites-book/) / [Repository](https://github.com/itdojp/theoretical-computer-science-prerequisites-book) |
...
| AIエージェント協働の仕事術 | `JA only; free preview` | All levels | Provides a practical framework for turning AI agents into work outcomes through request contracts, context packs, delegation, review, permissions, human judgment, and organizational rollout. GitHub Pages is intended to publish only the free-preview scope aligned with the Zenn free-publication boundary. | [Read](https://itdojp.github.io/ai-agent-collaboration-book/) / Repository private: paid-edition material included |
...
| 要件から始めるソフトウェア設計（小規模TS Webアプリの実践） | `JA only` | All levels | Starts software design from requirements and turns a small TypeScript web app into a coherent, reviewable structure. | [Read](https://itdojp.github.io/small-webapp-software-design-book/) / [Repository](https://github.com/itdojp/small-webapp-software-design-book) |
...
| Canonical title | Availability | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- |
| バイオインフォマティクス実践ガイド | `JA only` | Domain specialists | Bridges IT engineering and bioinformatics through workflows, data handling, and practical case studies. | [Read](https://itdojp.github.io/BioinformaticsGuide-book/) / [Repository](https://github.com/itdojp/BioinformaticsGuide-book) |
...
| Canonical title | Availability | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- |
| AI時代に差がつく論理的思考と表現力 | `JA only` | All levels | Improves logic, structure, and expression for clearer thinking and communication in the AI era. | [Read](https://itdojp.github.io/LogicalThinking-AI-Era-Guide/) / [Repository](https://github.com/itdojp/LogicalThinking-AI-Era-Guide) |
| AI時代のプロフェッショナルITエンジニアの思考法 | `JA only` | All levels | Focuses on professional judgment, habits, and decision-making for IT engineers working in the AI era. | [Read](https://itdojp.github.io/ai-era-engineers-mind-book/) / [Repository](https://github.com/itdojp/ai-era-engineers-mind-book) |
| 生成AIコミュニケーション技術 | `JA only` | All levels | Explains how to communicate effectively with generative AI through prompts, context control, and collaborative patterns. | [Read](https://itdojp.github.io/ai-communication-book/) / [Repository](https://github.com/itdojp/ai-communication-book) |
| エンジニアの交渉力アーキテクチャ | `JA only` | All levels | Treats negotiation as an engineering skill built from structure, trade-offs, and shared understanding. | [Read](https://itdojp.github.io/negotiation-for-engineers-book/) / [Repository](https://github.com/itdojp/negotiation-for-engineers-book) |
| エンジニアのための実践コミュニケーション設計 | `JA only` | All levels | Designs practical communication for engineers across teams, stakeholders, and delivery work. | [Read](https://itdojp.github.io/IT-engineer-communication-book/) / [Repository](https://github.com/itdojp/IT-engineer-communication-book) |
...
| Canonical title | Availability | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- |
| デジタル革命の先駆者たち | `JA only` | All levels | Introduces key people and ideas that shaped the digital revolution and modern computing culture. | [Read](https://itdojp.github.io/cs-visionaries-book/) / [Repository](https://github.com/itdojp/cs-visionaries-book) |
| 計算論的物理主義 | `JA only` | All levels | Explores computational physicalism and its implications for mind, intelligence, and engineered systems. | [Read](https://itdojp.github.io/computational-physicalism-book/) / [Repository](https://github.com/itdojp/computational-physicalism-book) |
...
| Canonical title | Availability | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- |
| Ethereum学習ブートキャンプ | `JA only` | Web3 learners | Introduces Ethereum fundamentals, smart contracts, tooling, and hands-on exercises. | [Read](https://itdojp.github.io/ethereum-learning-bootcamp/) / [Repository](https://github.com/itdojp/ethereum-learning-bootcamp) |
...
| Canonical title | Availability | Category | Audience | Short English summary | Links |
| --- | --- | --- | --- | --- | --- |
| インフラ性能管理・キャパシティプランニング | `Planned` | Advanced Infrastructure Practice | Intermediate+ | Planned guide to performance testing, bottleneck analysis, and capacity planning. | — |
| コンプライアンス対応インフラ設計・運用 | `Planned` | Security / Governance | Intermediate+ | Planned title on compliance-aware infrastructure design and operation for standards such as ISO 27001 and SOX. | — |
